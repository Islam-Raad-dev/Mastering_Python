...
myAwesomeTupleOne = ("ISLAM", "Ahmed")
myAwesomeTupleTwo = "ISLAM", "Ahmed"
...
myAwesomeTupleFive = ("ISLAM", "ISLAM", 1, 2, 3, 100.5, True)
...
print(f"The Position of Index Is: {B.index(7)}")igv 
