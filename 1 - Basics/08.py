...
# mySetThree = {"Islam", 100, 100.5, True, [1, 2, 3]} # unhashable type: 'list'
mySetThree = {"Islam", 100, 100.5, True, (1, 2, 3)}

print(mySetThree)

# Items Is Unique

mySetFour = {1, 2, "Islam", "One", "Islam", 1}
print(mySetFour)
